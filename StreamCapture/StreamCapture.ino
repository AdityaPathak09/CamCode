...
const char* ssid0     = "realme 3 Pro";   //your network SSID
const char* password0 = "1234567890";   //your network password
  ...
  while (true)
  {
    ...
    if (!digitalRead(camTrig)) {
      ...
      if (!digitalRead(camTrig)) {
        ...
        Serial.println(SendCapturedImage(fb));
...
String SendCapturedImage(camera_fb_t * fba) {
